import"../chunks/DsnmJJEf.js";import{N as B,w as O,bi as U,o as C,Q as K,aa as M,A as T,y as z,P as Q,M as W,p as F,d as b,e as X,f as E,g as f,a as y,s as x,r as h,t as N,b as R,u as H,c as w,al as Y,aK as G,bj as J}from"../chunks/DMucjYnI.js";import{s as Z}from"../chunks/CEo5zdez.js";import{i as V}from"../chunks/DjPDfx9E.js";import{a as _,e as A}from"../chunks/B4K5adKN.js";import{s as I,c as $}from"../chunks/CXJpA9QI.js";import{e as L}from"../chunks/lom2f_IR.js";import{a as ee,t as te}from"../chunks/BC4M4ZfT.js";import{s as P,S}from"../chunks/18qZlL5z.js";import{p as u}from"../chunks/BnLNXuza.js";import{d as ae,s as j}from"../chunks/BPMTC5_A.js";import{e as oe}from"../chunks/DIr2FkkK.js";import{g as se,o as re}from"../chunks/B_Yscb-x.js";import{r as D}from"../chunks/DL_8ej6M.js";function ne(s,d){let m=null,r=C;var t;if(C){m=Q;for(var e=W(document.head);e!==null&&(e.nodeType!==K||e.data!==s);)e=M(e);if(e===null)T(!1);else{var o=M(e);e.remove(),z(o)}}C||(t=document.head.appendChild(B()));try{O(()=>d(t),U)}finally{r&&(T(!0),z(m))}}const ie=!1,le=!0,ce=async()=>({now:Date.now()}),Ve=Object.freeze(Object.defineProperty({__proto__:null,load:ce,prerender:le,ssr:ie},Symbol.toStringTag,{value:"Module"})),de=(s,d=!0,m=!1)=>{let r=null;return()=>{r===null&&(typeof s=="string"?(r=document.createElement("template"),r.innerHTML=s.trim()):r=s);const t=r.content.cloneNode(!0),e={};if(m&&document.adoptNode(t),d){const o=t.querySelectorAll("[data-ref]");for(const c of o){const p=c.getAttribute("data-ref");if(p)if(p.endsWith("[]")){const l=p.slice(0,-2),n=Array.isArray(e[l])?e[l]:[];n.push(c),e[l]=n}else e[p]=c}}return{fragment:t,refs:e}}},me=`
  :host(:popover-open) {
    --bg-opacity: 80%;
    left: unset;
    top: unset;
